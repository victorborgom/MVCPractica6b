<?php
    ...
    class Request{
        ...
        //HASTA AQUI OK! pasa de query a param
        ///////////
        $max2 = count(self::$param);
        $cont3=0;
        $total=0;
        $parcial=0;
        $findme='=';
        ...
        for($cont3=0;$cont3<$max2; $cont3++)
        { 
        $total = count(self::$param[$cont3]);
        $parcial = strpos(self::$param[$cont3], $findme);
